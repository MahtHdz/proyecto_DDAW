...
<body>
    ...
    <div id="form" class="bg-dark">
        ...
        out.println("                <input type='text' name='super_classes' placeholder='Superclase 1, Superclase 2, Superclase 3, etc.' id='super_classes_list' value='"+obtenerTarjeta.obtenerTarjeta().getListaSuper()+"'><br><br>");
        out.println("                <label for='sub_classes_list'>Lista de subclases: </label>");
        out.println("                <input type='text' name='sub_classes' placeholder='Sublase 1, Sublase 2, Subclase 3, etc.' id='sub_classes_list' value='"+obtenerTarjeta.obtenerTarjeta().getListaSub()+"'><br><br><br>");
        out.println("            </div>");
...
//        out.println("                    <th scope='col'>#</th>");
        ...
        for(TablaTCRC colaborador : obtenerTarjeta.obtenerTarjeta().getTablaTarjetaCRC()){
        out.println("                  <tr>");
//        out.println("                    <th>#</th>");
