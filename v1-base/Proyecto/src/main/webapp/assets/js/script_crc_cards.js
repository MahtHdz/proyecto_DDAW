...
//  const ARR_LEN = document.getElementById("id_proyecto").value;
//    console.log(ARR_LEN);
//  const name_crc = document.getElementById("id_proyecto").value;
//  
...
//    img.setAttribute("alt", name_crc);
//    var figcaption = document.createElement("figcaption");
//    figcaption.textContent = name_crc;
